...
4. The observations table displays all data collected for the study:
   - Observation ID
   - Patient name
   ...
   - Status
   - Created date/time
5. Use filters to narrow the data:
   - **Patient**: Select specific patient
   - **Data Type**: Filter by codeable concept
   - **Date Range**: Filter by time period
6. Click on an observation row to view full details

**Console Tips:**
- Use date filters to track recent data uploads
- Filter by patient to check individual compliance
- Export data via REST API for analysis
